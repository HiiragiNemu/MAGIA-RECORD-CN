define(['common'], function (common) {
	...
	var tipsObj = [
		...
		//MN:衣装ストーリーは外す{"type":1,"image":"tips_21032.png"},
		{ "type": 1, "image": "tips_21033.png" },
		{ "type": 1, "image": "tips_21034.png" },
		{ "type": 1, "image": "tips_21035.png" },
		{"type":0,"title":"任务","text":"每日任务于每天0点更新"},
		{"type":0,"title":"服装切换","text":"获得魔法少女的服装时@可切换主页画面的魔法少女的服装"},
		{"type":0,"title":"Charge行动盘","text":"连续使用Charge行动盘后@Charge积攒，可施加大幅伤害"},
		{"type":0,"title":"Puella Combo","text":"用同一魔法少女进行攻击后@发动Puella连击，伤害上升"},
		{"type":0,"title":"目标选择","text":"点击敌人即可将其锁定为目标"},
		{"type":0,"title":"Connect","text":"用同一魔法少女攻击3次@即可能发动Connect"},
		{"type":0,"title":"魔法阵型","text":"由于阵形前列易受敌人攻击@请将防御力高的魔法少女配置在前列"},
		{"type":0,"title":"协助","text":"若选择未关注的玩家进行协助@则不可使用Magia和技能，请务必注意"},
		{"type":0,"title":"Accele Combo","text":"确定使用Accele连击后@全队成员的Magia蓄能条增加"},
		{"type":0,"title":"Blast Combo","text":"已确定使用Blast连击的回合中@伤害值增大"},
		{"type":0,"title":"Puella Combo","text":"用相同的行动盘发动Puella连击后@可施加更大的伤害"},
		{"type":0,"title":"取消行动盘","text":"点击已选择的行动盘即可取消选择@重新选择行动盘"},
		{"type":0,"title":"Magia","text":"Magia蓄能条积攒到100以上后@即可随时发动Magia"},
		{"type":0,"title":"技能","text":"即使正在选择行动盘@也可发动技能"},
		{"type":0,"title":"自动战斗","text":"已通关的战斗从第二次开始@即可进行自动战斗"},
		{"type":0,"title":"自动战斗","text":"取消自动战斗时，从下一回合起@即可手动操作"},
		{"type":0,"title":"协助Pt","text":"被其他玩家选中进行副本协助@可在第二天登录时获得协助Pt"},
		{"type":0,"title":"变更行动盘的样式","text":"可在魔法少女详情画面的设定中@变更行动盘的样式"},
		{"type":0,"title":"命运宝石","text":"再次获得已持有的魔法少女时@可获得该魔法少女的命运宝石"},
		{"type":0,"title":"命运宝石","text":"命运宝石可解放魔法少女的魔力@进行魔力解放后，即增加记忆结晶的装备框"},
		{"type":0,"title":"将命运宝石转换为魔法晶片","text":"可以在道具列表页面和魔力解放页面@将多余的命运宝石转换为魔法晶片"},
		{"type":0,"title":"魔法晶片","text":"命运宝石可变换为魔法晶片@魔法晶片可在商店中交换物品"},
		{"type":0,"title":"目标选择","text":"选择3枚行动盘时@每次都可以变更攻击目标"},
		{"type":0,"title":"Accele行动盘","text":"最初用Accele进行攻击后@行动盘的Magia蓄能条蓄能速度将加快"},
		{"type":0,"title":"Accele行动盘","text":"使用第2、第3枚Accele行动盘@Magia蓄能条的蓄能速度加快"},
		{"type":0,"title":"Blast行动盘","text":"使用第2、第3枚Blast行动盘@攻击时的伤害增大"},
		{"type":0,"title":"Blast行动盘","text":"Blast行动盘拥有2种攻击类型@即横向攻击和纵向攻击"},
		{"type":0,"title":"Blast行动盘","text":"用Blast行动盘攻击后@Magia蓄能条不会积攒，请务必注意"},
		{"type":0,"title":"行动盘的出现","text":"指定为队长的魔法少女@其行动盘的出现率提高"},
		{"type":0,"title":"魔女化身","text":"拥有魔女化身的魔法少女@在Magia蓄能条积攒到200时即可发动"},
		{"type":0,"title":"敌人信息","text":"长按敌人即可@显示出敌人的信息"},
		{"type":0,"title":"Charge效果","text":"在Charge已积攒的状态下释放Accele后@Magia蓄能条的获得量上升"},
		{"type":0,"title":"Charge效果","text":"在Charge已积攒的状态下释放Blast后@施加的伤害值上升"},
		{"type":0,"title":"魔女化身","text":"★5且Magia为5级的魔法少女@其魔女化身将在副本通关后解放"},
		{"type":0,"title":"记忆结晶","text":"技能和能力各可装备2枚记忆结晶@最大可装备4枚"},
		{"type":0,"title":"Magia等级","text":"Magia达到5级后，Magia蓄能条上限@解放至200"},
		{"type":0,"title":"Charge Combo","text":"确定使用Charge连击后Charge数增加2"},
		{"type":0,"title":"魔法少女的信息","text":"副本中长按魔法少女后@即能显示出该魔法少女的信息"},
		{"type":0,"title":"协助编成","text":"可在协助编成中设置@其他玩家可作为协助使用的魔法少女"},
		{"type":0,"title":"Magia通行证30天","text":"购买Magia通行证30天后的30天内@每天登录时可获得7个魔法石"},
		{"type":0,"title":"获得命运水晶的方法","text":"在转换初期稀有度为★4且魔力解放至最大的@魔法少女的命运宝石时可以获得命运水晶"}
		//{"type":0,"title":"How to Obtain Destiny Crystals","text":"Fully Unlock your Magical Girl's Magic to receive a Destiny Crystal along with the Magia Chips you get from exchanging a Destiny Gem. This is only applicable to natural ★4 Magical Girls that were drawn from a Fate Weave."}
	];
	...
	c.purchaseItem = function (model) {
		...
		if (window.isDebug) {
			// debug
			pack = 'jp.co.mynet.seed.' + model.moneyCode;
		} else {
			// 本番
			pack = 'com.aniplex.magireco.en.item.' + model.moneyCode;
		}
		/* MN
	...
	// MN:Adjustイベント計測
	c.setAdjustData = function (obj) {
		if (window.app_ver && common.versionCheck(window.app_ver, ">=", "1.0.16")) {
			var json = JSON.stringify(obj);
			var command = c.DATA_SET_ADJUST + ',' + json;
			this.sendCommand(command);
		}
	};
		...
		if (type !== "common") {
			...
			if (obj) {
				...
				param.description = (!obj.description || !obj.isVisibleCancel) ? "" :
					(type.indexOf("movie") > -1) ? "Downloading Video Data" :
						(type.indexOf("voice") > -1) ? "Downloading Voice Data" :
							obj.description;
				param.note = (!obj.note || !obj.isVisibleCancel) ? "" :
					(type.indexOf("movie") > -1) ? "※Movie Data can also be downloaded at a later time.\n※Wi-Fi is recommended for this download." :
						obj.note;
			}
	...
	/**
	 * MN:JSから送信したメッセージをネイティブのログに出力する
	 */
	c.sendMessageLog = function (object) {
		if (!window.isDebug) return;
		if (window.app_ver && common.versionCheck(window.app_ver, ">=", "1.1.13")) {
			var json = JSON.stringify(object);
			var command = c.SEND_MESSAGE_LOG + "," + json;
			this.sendCommand(command);
	 ...
	 */
	c.saveDataToLocal = function (str) {
		var toStr = str.toString();
		var command = c.DATA_LOCAL_SAVE + ',' + toStr;
		this.sendCommand(command);
	};
	/**
	 * ローカルに保存しているデータ読み込み
	 */
	c.loadDataToLocal = function () {
		var command = c.DATA_LOCAL_LOAD;
		this.sendCommand(command);
	};
